...
public enum NtkHTTPMethod: String, RawRepresentable, Sendable, CaseIterable {
    /// `CONNECT` method.
...
/// 网络请求协议
/// 定义了网络请求的基本属性和行为
public protocol iNtkRequest: Sendable, CustomStringConvertible, CustomDebugStringConvertible {
