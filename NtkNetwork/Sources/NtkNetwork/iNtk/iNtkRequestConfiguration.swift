...
public protocol iNtkParameterFilter: Sendable {
    /// 过滤不参与缓存键生成的请求头
...
/// 请求配置协议
/// 定义了网络请求的缓存配置和参数过滤行为
public protocol iNtkRequestConfiguration: iNtkParameterFilter {
...
public struct NtkDefaultRequestConfiguration: iNtkRequestConfiguration {
    ...
    public func filterParameters(_ parameters: [String: Sendable]) -> [String: Sendable] {
    ...
    public func filterParameter(_ parameter: [String: Sendable]) -> [String: Sendable] {
    ...
    public func cachePolicy(_ response: any iNtkResponse) -> Bool {
