...
public struct NtkExponentialBackoffRetryPolicy: iNtkRetryPolicy {
    /// 最大重试次数
...
extension NtkExponentialBackoffRetryPolicy {
    /// 快速重试策略：最多3次，延迟较短
    public static var fast: NtkExponentialBackoffRetryPolicy {
    ...
    /// 标准重试策略：最多5次，中等延迟
    public static var standard: NtkExponentialBackoffRetryPolicy {
        return NtkExponentialBackoffRetryPolicy(
            maxRetryCount: 5,
            baseDelay: 1.0,
            multiplier: 2.0,
    ...
    /// 慢速重试策略：最多7次，延迟较长
    public static var slow: NtkExponentialBackoffRetryPolicy {
        return NtkExponentialBackoffRetryPolicy(
            maxRetryCount: 7,
            baseDelay: 2.0,
            multiplier: 1.5,
