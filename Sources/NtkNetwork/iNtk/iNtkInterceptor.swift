...
public enum iNtkInterceptorPriority: Int {
    /// 低优先级（250）
    case low    = 250
    /// 中等优先级（750）
    case medium = 750
...
extension Int {
    /// 低优先级值（250）
    public static let low: Int = iNtkInterceptorPriority.low.rawValue
    /// 中等优先级值（750）
    public static let medium: Int = iNtkInterceptorPriority.medium.rawValue
    /// 高优先级值（1000）
    public static let high: Int = iNtkInterceptorPriority.high.rawValue
}
