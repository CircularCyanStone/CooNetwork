...
static NSString * const kMPaaSSystemVersion = @"SystemVersion";
...
extern NSString * const kMPaaSOtherBehaviorBiz;     //未传biztype的行为埋点默认为mPaaSOtherBehaviorBiz
extern NSString * const kMPaaSOtherPerformanceBiz;     //未传biztype的性能埋点默认为mPaaSOtherPerformanceBiz
